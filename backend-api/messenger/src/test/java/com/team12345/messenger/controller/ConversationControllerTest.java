...
class ConversationControllerTest {
    ...
    void getConversationDetails_WhenParticipant_ShouldReturnDTO() throws Exception {
        ...
        mockMvc.perform(get("/conversations/1").with(authentication(auth)))
                .andExpect(status().isOk())
    ...
    void removeParticipant_ShouldReturnNoContent() throws Exception {
        mockMvc.perform(delete("/conversations/1/participants/2").with(authentication(auth)))
    ...
    void getMessages_ShouldReturnPage() throws Exception {
        ...
        mockMvc.perform(get("/conversations/1/messages").with(authentication(auth)))
                .andExpect(status().isOk())
